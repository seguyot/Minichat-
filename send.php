...
$req = $bdd->prepare('INSERT INTO mini_chat_Celine.messages (pseudo, message,date,ip, user_agent) VALUES(?, ?,NOW(), ?,?)');
...
if ($pseudoExist->fetchColumn() === '0') {
    ...
    $speudoCol = $bdd->prepare('INSERT INTO mini_chat_Celinet.users (pseudo, color) VALUES(?, ?)');
